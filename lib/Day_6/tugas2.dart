        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text(
                "Tride adalah aplikasi Smart Travel Planner yang membantu pengguna merencanakan perjalanan dengan lebih mudah. Pengguna cukup memasukkan tujuan, tanggal, durasi, dan budget, kemudian aplikasi akan membantu menyusun itinerary, memperkirakan biaya, menampilkan cuaca, serta memudahkan navigasi dalam satu aplikasi. Tride adalah aplikasi Smart Travel Planner yang membantu pengguna merencanakan perjalanan dengan lebih mudah. Pengguna cukup memasukkan tujuan, tanggal, durasi, dan budget, kemudian aplikasi akan membantu menyusun itinerary, memperkirakan biaya, menampilkan cuaca, serta memudahkan navigasi dalam satu aplikasi.Tride adalah aplikasi Smart Travel Planner yang membantu pengguna merencanakan perjalanan dengan lebih mudah. Pengguna cukup memasukkan tujuan, tanggal, durasi, dan budget, kemudian aplikasi akan membantu menyusun itinerary, memperkirakan biaya, menampilkan cuaca, serta memudahkan navigasi dalam satu aplikasi.Tride adalah aplikasi Smart Travel Planner yang membantu pengguna merencanakan perjalanan dengan lebih mudah. Pengguna cukup memasukkan tujuan, tanggal, durasi, dan budget, kemudian aplikasi akan membantu menyusun itinerary, memperkirakan biaya, menampilkan cuaca, serta memudahkan navigasi dalam satu aplikasi.",
